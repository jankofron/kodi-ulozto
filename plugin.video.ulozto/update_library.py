...
URL = 'https://api.themoviedb.org/3/search/movie?query={}&include_adult=false&language=cs'
URL_ID = 'https://api.themoviedb.org/3/{}/{}?language=cs'
MOVIE = 'movie'
SERIES = 'tv'
...
TMDB_REQUEST_HEADERS = {
    ...
    "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkNzkwM2JjYTk1MWE1NWY0NzljOWM0ZjVhNjc4YWY3OSIsIm5iZiI6MTQ2NDA5OTU2NC40NzIsInN1YiI6IjU3NDQ2MmVjOTI1MTQxNGMwODAwMjNmNSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.svg1NyTYCfU24BGkgNN_1vYqJo6uR4AooLh84YdZasc"
}
...
def get_movie_details_by_id(id: str) -> dict:
    url_movie = URL_ID.format(MOVIE, id)
    url_series = URL_ID.format(SERIES, id)
...
def get_art(id: str):
    ...
    local_path = COVERART_FOLDER + id
    if not xbmcvfs.exists(local_path):
        image_path = IMAGE_URL.format(id)
...
if __name__ == "__main__":
    ...
    ulozto_api.show_notification(addon.getLocalizedString(30010))
